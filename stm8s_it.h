...
/* Exported functions ------------------------------------------------------- */
 ...
 INTERRUPT_HANDLER(TIM1_CAP_COM_IRQHandler, 11); /* TIM1 CAP/COM */
 INTERRUPT_HANDLER(TIM1_UPD_OVF_TRG_BRK_IRQHandler, 12); /* TIM1 UPD/OVF/TRG/BRK */
 ...
 INTERRUPT_HANDLER(UART2_RX_IRQHandler, 20); /* UART2 RX */
 INTERRUPT_HANDLER(UART2_TX_IRQHandler, 21); /* UART2 TX */
